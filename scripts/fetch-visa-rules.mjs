...
const SLUGS = {
  ...
  kazakhstan: ['kazahstan'], kyrgyzstan: ['kyrgyzstan', 'kirgiziya'],
  uzbekistan: ['uzbekistan'], tajikistan: ['tadzhikistan'],
  georgia: ['georgia'], moldova: ['moldova', 'moldaviya', 'moldova-1'], serbia: ['serbia'],
  montenegro: ['montenegro'],
  bosnia: ['bosniya', 'bosniya-i-gercegovina', 'bosnia-i-gercegovina', 'bosnia'],
  macedonia: ['makedoniya', 'severnaya-makedoniya', 'macedonia'], albania: ['albania'],
  cyprus: ['cyprus'], uk: ['velikobritaniya', 'great-britain', 'britain', 'england'],
  malaysia: ['malaysia'], indonesia: ['indonesia'], philippines: ['filippiny'],
  singapore: ['singapore'], cambodia: ['kambodja', 'kambodzha'], laos: ['laos'],
  myanmar: ['myanma', 'mianmar', 'birma', 'myanmar'], nepal: ['nepal'], mongolia: ['mongoliya'],
  hongkong: ['gonkong', 'hong-kong', 'hongkong'], macao: ['makao', 'macao'],
  southkorea: ['republic-korea'], japan: ['japan'], taiwan: ['tayvan'],
  israel: ['izrail', 'israel'], jordan: ['jordan'], bahrain: ['bahrain'], saudi: ['saudi'],
  kuwait: ['kuveyt', 'kuwait'], iran: ['iran'], tunisia: ['tunisia'], morocco: ['morocco'],
  southafrica: ['rsa'], kenya: ['kenya'], tanzania: ['tanzania'],
  mauritius: ['mauritius'], mexico: ['mexico'], dominicana: ['dominican'],
  jamaica: ['yamayka', 'jamaica'], brazil: ['brazilia'], argentina: ['argentina'],
  chile: ['chili'], peru: ['peru'], costarica: ['kosta-rika', 'costa-rica'],
  usa: ['usa'], canada: ['kanada', 'canada'], australia: ['avstraliya', 'australia'],
  newzealand: ['novaya-zelandiya', 'new-zealand', 'novaa-zelandia'], italy: ['italy'],
  russia: ['russia'],
}
